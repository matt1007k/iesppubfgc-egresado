...
class EAEL_Parallax_Section
{
    ...
    {
        $elementor3 = apply_filters('eael/helper/version_compare', 'elementor/elementor.php', 3, '>=');
        ...
        if (!$elementor3) {
            $effects['multi'] = __('Multi-Layered', 'essential-addons-elementor');
        }
    ...
    public function after_render($element)
    {
        ...
        if ('section' === $type && isset($parallax)
