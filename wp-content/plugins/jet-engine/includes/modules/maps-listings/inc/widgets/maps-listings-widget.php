...
class Maps_Listings_Widget extends \Elementor\Jet_Listing_Grid_Widget {
	...
	public function register_general_settings() {
		...
		$this->add_control(
			'add_lat_lng',
			array(
				'label'   => esc_html__( 'Use Lat Lng Address Meta Field', 'jet-elements' ),
		...
		$this->add_control(
			'auto_center',
			array(
				'label'   => esc_html__( 'Automatically detect map center', 'jet-elements' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Use differnt markers by conditions', 'jet-elements' ),
				'type'        => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			array(
				...
				'fields'  => array_values( $markers_repeater->get_controls() ),
				'default' => array(),
				'condition' => array(
	...
	public function render_posts() {
		$instance = Module::instance()->get_render_instance( $this->get_widget_settings() );
		$instance->render();
	}
